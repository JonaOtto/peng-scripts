...
class App:
    ...
    ISSM_ANNOTATED_MINIAPP_STRESSBALANCE = "ISSM-ANNOTATED-MINIAPP-STRESSBALANCE"
    ISSM_ANNOTATED_MINIAPP_THERMAL = "ISSM-ANNOTATED-MINIAPP-THERMAL"
    ISSM_CUSTOM_ANNOTATED_MINIAPP_STRESSBALANCE = "ISSM-CUSTOM-ANNOTATED-MINIAPP-STRESSBALANCE"
    ISSM_CUSTOM_ANNOTATED_MINIAPP_THERMAL = "ISSM-CUSTOM-ANNOTATED-MINIAPP-THERMAL"
    ...
    def get(cls, app_name):
        ...
        elif app_name == App.ISSM_ANNOTATED_MINIAPP_THERMAL:
            return App.ISSM_ANNOTATED_MINIAPP_THERMAL
        elif app_name == App.ISSM_ANNOTATED_MINIAPP_STRESSBALANCE:
            return App.ISSM_ANNOTATED_MINIAPP_STRESSBALANCE
        else:
