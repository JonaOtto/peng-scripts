...
from Builder.builder import BasicBuilder
...
job_file_archive = "/home/kurse/kurs00054/jo83xafu/jobfile_archive"
...
class BaseRun:
    ...
    def run(self):
        ...
        out_path, error_path = self.slurm_configuration.wait(job_id)
        print("FINISHED!!!!")
